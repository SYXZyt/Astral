...
Astral::Type::atype_t* Greater_Number_Number(Astral::Type::number_t* lhs, Astral::Type::number_t* rhs)
{
    float res = lhs->Value() > rhs->Value();
    Cleanup(lhs, rhs);
    return new Astral::Type::number_t(res);
...
Astral::Type::atype_t* Greater_Equals_Number_Number(Astral::Type::number_t* lhs, Astral::Type::number_t* rhs)
{
    float res = lhs->Value() >= rhs->Value();
    Cleanup(lhs, rhs);
    return new Astral::Type::number_t(res);
...
Astral::Type::atype_t* Less_Number_Number(Astral::Type::number_t* lhs, Astral::Type::number_t* rhs)
{
    float res = lhs->Value() < rhs->Value();
    Cleanup(lhs, rhs);
    return new Astral::Type::number_t(res);
...
Astral::Type::atype_t* Less_Equals_Number_Number(Astral::Type::number_t* lhs, Astral::Type::number_t* rhs)
{
    float res = lhs->Value() <= rhs->Value();
    Cleanup(lhs, rhs);
    return new Astral::Type::number_t(res);
